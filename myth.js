...
define("NameGen", ["require", "exports"], function (require, exports) {
    "use strict";
    exports.__esModule = true;
    /**
     ...
     * https://github.com/skeeto/fantasyname/blob/master/js/namegen.js
     *
     * @example
    ...
    var NameGen = (function () {
        function NameGen(template, rand) {
            this.template = template;
            this.rand = rand;
        }
        NameGen.prototype.generate = function () {
            var s = "";
            var tt = this.rand.pick(this.template);
            for (var i = 0, len = tt.length; i < len; i++) {
                if (symbols[tt[i]]) {
                    s += this.rand.pick(symbols[tt[i]]);
                }
                else {
                    s += tt[i];
                }
...
let n = new NameGen(["sV'dD", "ss'sV"], rand);
...
*/ 
define("myth", ["require", "exports", "RNG", "NameGen"], function (require, exports, RNG_1, NameGen_1) {
    "use strict";
    exports.__esModule = true;
    var C;
    (function (C) {
